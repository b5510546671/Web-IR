...
//			alert(pros);
  ...
  <div id="posts1">
    <div class="post1">
      <h2 class="title">&nbsp;</h2>
      <div class="meta">
      <h2 class="title">สมัครสมาชิกประเภทบุคคล</h2>
      </table>
      </div>
<table width="100%" border="0" style="font-size:18px" cellpadding="0" cellspacing="0">
<tr align="right">
<td>
<a href="register_com.php"><input name="company" type="button" value="ประเภทบริษัท" /></a>
</td>
</tr>
</table>
...
<!-------------------------------------------------------------------------------------------------->
  ...
  <tr>
    <td>รหัสประชาชน</td>
    <td valign="top"><div id="div_citizen" name="div_citizen">
