...
var ewr_token = "e4wxbwn2rzpqnccwn-wu8a..";
...
// create page object
var crosstab_tranning_countbytype_crosstab = new ewr_page("crosstab_tranning_countbytype_crosstab");

// page properties
crosstab_tranning_countbytype_crosstab.pageid = "crosstab"; // page id
var ewr_page_id = crosstab_tranning_countbytype_crosstab.pageid;

// extend page with chart_rendering function
crosstab_tranning_countbytype_crosstab.chart_rendering = 
...
crosstab_tranning_countbytype_crosstab.chart_rendered = 
 function(chart, chartid) { // do not change this line!
...
<!-- top slot -->
<div class="ewtoolbar">
<ul class="breadcrumb ewbreadcrumbs"><li id="ewbreadcrumb1"><a href="program_plist.php" title="home" class="ewhome"><span data-phrase="homepage" class="glyphicon glyphicon-home ewicon" data-caption="home"></span></a></li><li id="ewbreadcrumb2" class="active"><span id="ewpagecaption">จำนวนการถ่ายทอดเทคโนโลยีแยกตามประเภท</span></li></ul><div class="ewexportoption ewlistoptionseparator" style="white-space: nowrap;" data-name="button"><div class="btn-group ewbuttongroup"><a class="btn btn-default"  title="export to excel" data-caption="export to excel" href="crosstab_tranning_countbytypectb.php?export=excel"><span data-phrase="exporttoexcel" class="icon-excel ewicon" data-caption="export to excel"></span></a></div></div><div class="clearfix"></div>
</div>
...
<thead>
	...
	<tr class="ewtableheader">
		<td class="ewrptcolsummary" colspan="1"><div><ul class="list-unstyled ewcrosstabvalues"><li>id (count)</li></ul></div></td>
	...
	<td data-field="fullname">
		<div class="ewtableheaderbtn crosstab_tranning_countbytype_fullname">
...
<span data-class="tpx1_crosstab_tranning_countbytype_fullname">มหาวิทยาลัยขอนแก่น</span></td>
<!-- dynamic columns begin -->
		<!-- จัดนิทรรศการ -->
		...
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>0</span></li></ul></td>
		<!-- summary -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>21</span></li></ul></td>
<!-- dynamic columns end -->
	</tr>
	<tr>
		<!-- fullname -->
		<td data-field="fullname" class="ewrptgrpfield1">
<span data-class="tpx2_crosstab_tranning_countbytype_fullname">มหาวิทยาลัยมหิดล</span></td>
<!-- dynamic columns begin -->
		<!-- จัดนิทรรศการ -->
...
<!-- dynamic columns end -->
	...
	<tr>
		<!-- fullname -->
		<td data-field="fullname" class="ewrptgrpfield1">
<span data-class="tpx3_crosstab_tranning_countbytype_fullname">มหาวิทยาลัยสงขลานครินทร์</span></td>
<!-- dynamic columns begin -->
		<!-- จัดนิทรรศการ -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>0</span></li></ul></td>
		<!-- บรรยาย -->
...
<!-- dynamic columns end -->
	...
	<tr>
		<!-- fullname -->
		<td data-field="fullname" class="ewrptgrpfield1">
<span data-class="tpx4_crosstab_tranning_countbytype_fullname">มหาวิทยาลัยเกษตรศาสตร์</span></td>
<!-- dynamic columns begin -->
		<!-- จัดนิทรรศการ -->
		<td style="text-align: right;" class="ewtablealtrow"><ul class="list-unstyled ewcrosstabvalues"><li><span>9</span></li></ul></td>
		<!-- บรรยาย -->
		<td style="text-align: right;" class="ewtablealtrow"><ul class="list-unstyled ewcrosstabvalues"><li><span>247</span></li></ul></td>
		<!-- ประชุมกลุ่มย่อย -->
		<td style="text-align: right;" class="ewtablealtrow"><ul class="list-unstyled ewcrosstabvalues"><li><span>1</span></li></ul></td>
		<!-- ประชุมวิชาการ -->
		<td style="text-align: right;" class="ewtablealtrow"><ul class="list-unstyled ewcrosstabvalues"><li><span>8</span></li></ul></td>
		<!-- ฝึกอบรม -->
		<td style="text-align: right;" class="ewtablealtrow"><ul class="list-unstyled ewcrosstabvalues"><li><span>171</span></li></ul></td>
		<!-- อื่น ๆ -->
		<td style="text-align: right;" class="ewtablealtrow"><ul class="list-unstyled ewcrosstabvalues"><li><span>8</span></li></ul></td>
		<!-- summary -->
		<td style="text-align: right;" class="ewtablealtrow"><ul class="list-unstyled ewcrosstabvalues"><li><span>444</span></li></ul></td>
<!-- dynamic columns end -->
	</tr>
	<tr>
		<!-- fullname -->
		<td data-field="fullname" class="ewrptgrpfield1">
<span data-class="tpx5_crosstab_tranning_countbytype_fullname">มหาวิทยาลัยเชียงใหม่</span></td>
<!-- dynamic columns begin -->
		<!-- จัดนิทรรศการ -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>6</span></li></ul></td>
		<!-- บรรยาย -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>74</span></li></ul></td>
		<!-- ประชุมกลุ่มย่อย -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>13</span></li></ul></td>
		<!-- ประชุมวิชาการ -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>1</span></li></ul></td>
		<!-- ฝึกอบรม -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>37</span></li></ul></td>
		<!-- อื่น ๆ -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>15</span></li></ul></td>
		<!-- summary -->
		<td style="text-align: right;" class="ewtablerow"><ul class="list-unstyled ewcrosstabvalues"><li><span>146</span></li></ul></td>
<!-- dynamic columns end -->
	</tr>
	<tr>
		<!-- fullname -->
		<td data-field="fullname" class="ewrptgrpfield1">
<span data-class="tpx6_crosstab_tranning_countbytype_fullname">สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง</span></td>
<!-- dynamic columns begin -->
		<!-- จัดนิทรรศการ -->
		<td style="text-align: right;" class="ewtablealtrow"><ul class="list-unstyled ewcrosstabvalues"><li><span>2</span></li></ul></td>
		<!-- บรรยาย -->
...
<!-- dynamic columns begin -->
		<!-- จัดนิทรรศการ -->
		<td style="text-align: right;"><ul class="list-unstyled ewcrosstabvalues"><li><span>20</span></li></ul></td>
		<!-- บรรยาย -->
		<td style="text-align: right;"><ul class="list-unstyled ewcrosstabvalues"><li><span>334</span></li></ul></td>
		<!-- ประชุมกลุ่มย่อย -->
		<td style="text-align: right;"><ul class="list-unstyled ewcrosstabvalues"><li><span>14</span></li></ul></td>
		<!-- ประชุมวิชาการ -->
		<td style="text-align: right;"><ul class="list-unstyled ewcrosstabvalues"><li><span>16</span></li></ul></td>
		<!-- ฝึกอบรม -->
		<td style="text-align: right;"><ul class="list-unstyled ewcrosstabvalues"><li><span>220</span></li></ul></td>
		<!-- อื่น ๆ -->
		<td style="text-align: right;"><ul class="list-unstyled ewcrosstabvalues"><li><span>23</span></li></ul></td>
		<!-- summary -->
		<td style="text-align: right;"><ul class="list-unstyled ewcrosstabvalues"><li><span>627</span></li></ul></td>
<!-- dynamic columns end -->
	</tr>
</tfoot>
</table>
...
<form action="crosstab_tranning_countbytypectb.php" name="ewpagerform" class="ewform form-horizontal">
<div class="ewpager">
<input type="hidden" name="t" value="crosstab_tranning_countbytype">
