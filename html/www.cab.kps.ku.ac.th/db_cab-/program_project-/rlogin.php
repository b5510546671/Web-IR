...
var ewr_token = "zfokhqaeyyo5ah2celio_w..";
...
<div class="ewtoolbar">
<ul class="breadcrumb ewbreadcrumbs"><li id="ewbreadcrumb1"><a href="program_plist.php" title="home" class="ewhome"><span data-phrase="homepage" class="glyphicon glyphicon-home ewicon" data-caption="home"></span></a></li><li id="ewbreadcrumb2" class="active"><span id="ewpagecaption">login page</span></li></ul><div class="clearfix"></div>
</div>
<div class="ewmessagedialog ewdisplaytable"></div><form name="frptlogin" id="frptlogin" class="form-horizontal ewform ewloginform" action="rlogin.php" method="post">
<input type="hidden" name="token" value="zfokhqaeyyo5ah2celio_w..">
