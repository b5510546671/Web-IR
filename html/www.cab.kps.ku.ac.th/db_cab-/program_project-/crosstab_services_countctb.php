...
var ewr_token = "7fziet0g2peky5irpcrwea..";
...
// create page object
var crosstab_services_count_crosstab = new ewr_page("crosstab_services_count_crosstab");

// page properties
crosstab_services_count_crosstab.pageid = "crosstab"; // page id
var ewr_page_id = crosstab_services_count_crosstab.pageid;

// extend page with chart_rendering function
crosstab_services_count_crosstab.chart_rendering = 
...
crosstab_services_count_crosstab.chart_rendered = 
 function(chart, chartid) { // do not change this line!
...
<!-- top slot -->
<div class="ewtoolbar">
<ul class="breadcrumb ewbreadcrumbs"><li id="ewbreadcrumb1"><a href="program_plist.php" title="home" class="ewhome"><span data-phrase="homepage" class="glyphicon glyphicon-home ewicon" data-caption="home"></span></a></li><li id="ewbreadcrumb2" class="active"><span id="ewpagecaption">จำนวนครั้งการให้บริการทางวิชาการ</span></li></ul><div class="ewexportoption ewlistoptionseparator" style="white-space: nowrap;" data-name="button"><div class="btn-group ewbuttongroup"><a class="btn btn-default"  title="export to excel" data-caption="export to excel" href="crosstab_services_countctb.php?export=excel"><span data-phrase="exporttoexcel" class="icon-excel ewicon" data-caption="export to excel"></span></a></div></div><div class="clearfix"></div>
</div>
