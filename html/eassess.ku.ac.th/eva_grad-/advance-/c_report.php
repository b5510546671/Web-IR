 ...
 var index;
  if(document.getelementbyid("dis_rpt1").checked){
   ...
   var my_file = new array();
	my_file[1] = "c_table1.php";
	my_file[2] = "c_table2.php";
	my_file[3] = "c_table3.php";
	my_file[4] = "c_table4.php";
	my_file[5] = "c_table5.php";
	my_file[6] = "c_table6.php";
	my_file[7] = "#";
	my_file[8] = "#";
	my_file[9] = "#";
	file_location = my_file[index]+"?qa_year="+year+"&index="+index+"&camp="+camp;
	window.open(file_location,'_blank');
}
</script>
    <div id="template_main">
    <form name="form1" id="form1" method="post">
	<p class="redtext" align="center">รายงานระดับวิทยาเขต</p>
	<div style="margin-left:395px"><table  width="40%" border="0" ><tr><td width="47%">ประจำปี พ.ศ. ::</td>
	<td width="53%"><select name="rpt_year" id="rpt_year">
	...
	<tr><td>วิทยาเขต ::</td><td><select name="rpt_camp" id="rpt_camp">
