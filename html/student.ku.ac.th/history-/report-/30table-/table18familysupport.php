...
<html>
    <head>
        ...
        <title>
             3.18 ผู้อุปการะค่าเล่าเรียน และค่าใช้จ่ายส่วนตัวของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table18familysupport_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table18familysupport_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table18familysupport_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.18 ผู้อุปการะค่าเล่าเรียน และค่าใช้จ่ายส่วนตัวของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a href="./table18familysupport_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ผู้อุปการะค่าเล่าเรียน และค่าใช้จ่ายส่วนตัว</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>บิดา</td><td bgcolor=#97d079>มารดา</td><td bgcolor=#97d079>พี่</td><td bgcolor=#97d07>ญาติ</td><td bgcolor=#97d079>ทุนการศึกษา</td><td bgcolor=#97d079>ทุนกู้ยืมฯ(icl)</td><td bgcolor=#97d079>หาเงินเรียนเอง</td><td bgcolor=#97d079>อื่นๆ</td></tr></table>	</td></tr></table>',
			
        title: ' 3.18 ผู้อุปการะค่าเล่าเรียน และค่าใช้จ่ายส่วนตัวของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_18_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ผู้อุปการะค่าเล่าเรียน และค่าใช้จ่ายส่วนตัว</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>บิดา</td><td bgcolor=#97d079>มารดา</td><td bgcolor=#97d079>พี่</td><td bgcolor=#97d07>ญาติ</td><td bgcolor=#97d079>ทุนการศึกษา</td><td bgcolor=#97d079>ทุนกู้ยืมฯ(icl)</td><td bgcolor=#97d079>หาเงินเรียนเอง</td><td bgcolor=#97d079>อื่นๆ</td><td bgcolor=#97d079>บิดาและมารดา</td></tr></table>	</td></tr></table>',
        width: 1840,
        height: 600,
