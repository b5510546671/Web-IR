...
<html>
    <head>
        ...
        <title>
             3.24 ความประสงค์ในการทำงานพิเศษหรือฝึกงานในระหว่างปิดภาคเรียนของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table24activitytraining_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table24activitytraining_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table24activitytraining_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.24 ความประสงค์ในการทำงานพิเศษหรือฝึกงานในระหว่างปิดภาคเรียนของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 40px;"><a href="./table24activitytraining_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=5>ความประสงค์ในการทำงานพิเศษหรือ<br>ฝึกงานในระหว่างปิดภาคเรียน</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ประสงค์</td><td bgcolor=#97d079>ไม่ประสงค์</td></tr></table>	</td></tr></table>',
			
        title: ' 3.24 ความประสงค์ในการทำงานพิเศษหรือฝึกงานในระหว่างปิดภาคเรียนของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 40px;"><a target="_blank" href="./3_24_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=5>ความประสงค์ในการทำงานพิเศษหรือ<br>ฝึกงานในระหว่างปิดภาคเรียน</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ประสงค์</td><td bgcolor=#97d079>ไม่ประสงค์</td></tr></table>	</td></tr></table>',
        width: 820,
        height: 600,
