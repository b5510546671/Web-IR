...
<html>
    <head>
        ...
        <title>
             3.10 ภาคที่จบการศึกษาของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table10provinceschool_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table10provinceschool_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table10provinceschool_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.10 ภาคที่จบการศึกษาของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a href="./table10provinceschool_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=8>ภาคที่จบการศึกษา</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>กรุงเทพมหานคร</td><td bgcolor=#97d079>กลาง</td><td bgcolor=#97d079>ตะวันออก</td><td bgcolor=#97d079>ตะวันออกเฉียงเหนือ</td><td bgcolor=#97d079>เหนือ</td><td bgcolor=#97d079>ตะวันตก</td><td bgcolor=#97d079>ใต้</td><td bgcolor=#97d079>ต่างประเทศ</td></tr></table>	</td></tr></table>',
			
        title: ' 3.10 ภาคที่จบการศึกษาของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_10_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=8>ภาคที่จบการศึกษา</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>กรุงเทพมหานคร</td><td bgcolor=#97d079>กลาง</td><td bgcolor=#97d079>ตะวันออก</td><td bgcolor=#97d079>ตะวันออกเฉียงเหนือ</td><td bgcolor=#97d079>เหนือ</td><td bgcolor=#97d079>ตะวันตก</td><td bgcolor=#97d079>ใต้</td><td bgcolor=#97d079>ต่างประเทศ</td></tr></table>	</td></tr></table>',
        width: 1698,
        height: 600,
