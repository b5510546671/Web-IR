...
<html>
    <head>
        ...
        <title>
             3.22 ความสนใจในการเข้าร่วมกิจกรรมขณะศึกษาในมหาวิทยาลัยของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table22activityacku_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table22activityacku_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table22activityacku_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: '3.22 ความสนใจในการเข้าร่วมกิจกรรมขณะศึกษาในมหาวิทยาลัยของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a href="./table22activityacku_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=11>ความสนใจในการเข้าร่วมกิจกรรมขณะศึกษาในมหาวิทยาลัย</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>การเมือง</td><td bgcolor=#97d079>กีฬาและเชียร์</td><td bgcolor=#97d079>ดนตรีและนาฎศิลป์</td><td bgcolor=#97d07>เทคโนโลยีสารสนเทศ</td><td bgcolor=#97d079>วรรณกรรมและวาทศิลป์</td><td bgcolor=#97d079>ศาสนา</td><td bgcolor=#97d079>ศิลปะ</td><td bgcolor=#97d079>วิชาการ</td><td bgcolor=#97d079>พัฒนาชุมชนและ<br>บำเพ็ญประโยชน์ </td><td bgcolor=#97d079>สิ่งแวดล้อม</td><td bgcolor=#97d079>ไม่เข้าร่วมกิจกรรม</td></tr></table>	</td></tr></table>',
			
        title: '3.22 ความสนใจในการเข้าร่วมกิจกรรมขณะศึกษาในมหาวิทยาลัยของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_22_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=11>ความสนใจในการเข้าร่วมกิจกรรมขณะศึกษาในมหาวิทยาลัย</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>การเมือง</td><td bgcolor=#97d079>กีฬาและเชียร์</td><td bgcolor=#97d079>ดนตรีและนาฎศิลป์</td><td bgcolor=#97d07>เทคโนโลยีสารสนเทศ</td><td bgcolor=#97d079>วรรณกรรมและวาทศิลป์</td><td bgcolor=#97d079>ศาสนา</td><td bgcolor=#97d079>ศิลปะ</td><td bgcolor=#97d079>วิชาการ</td><td bgcolor=#97d079>พัฒนาชุมชนและ<br>บำเพ็ญประโยชน์ </td><td bgcolor=#97d079>สิ่งแวดล้อม</td><td bgcolor=#97d079>ไม่เข้าร่วมกิจกรรม</td></tr></table>	</td></tr></table>',
        width: 2136,
        height: 600,
