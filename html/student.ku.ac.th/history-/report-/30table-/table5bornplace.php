...
<html>
    <head>
        ...
        <title>
             3.5 ภูมิลำเนาและจังหวัดที่เกิดของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table5bornplace_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table5bornplace_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table5bornplace_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.5 ภูมิลำเนาและจังหวัดที่เกิดของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 795px;"><a href="./table5bornplace_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ภูมิลำเนาและจังหวัดที่เกิด</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>บางเขน</td><td bgcolor=#97d079>กำแพงแสน</td><td bgcolor=#97d079>ศรีราชา</td><td bgcolor=#97d07>เฉลิมพระเกียรติ<br>จังหวัดสกลนคร</td><td bgcolor=#97d079>โครงการจัดตั้ง<br>วิทยาเขตสุพรรณบุรี</td><td bgcolor=#97d079>สถาบันสมทบ</td></tr></table>	</td></tr></table>',

        title: ' 3.5 ภูมิลำเนาและจังหวัดที่เกิดของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 795px;"><a target="_blank" href="./3_5_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ภูมิลำเนาและจังหวัดที่เกิด</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>บางเขน</td><td bgcolor=#97d079>กำแพงแสน</td><td bgcolor=#97d079>ศรีราชา</td><td bgcolor=#97d07>เฉลิมพระเกียรติ<br>จังหวัดสกลนคร</td><td bgcolor=#97d079>โครงการจัดตั้ง<br>วิทยาเขตสุพรรณบุรี</td><td bgcolor=#97d079>สถาบันสมทบ</td></tr></table>	</td></tr></table>',
