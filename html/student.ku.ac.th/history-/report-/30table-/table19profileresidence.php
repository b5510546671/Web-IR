...
<html>
    <head>
        ...
        <title>
             3.19 ลักษณะที่อยู่อาศัยในระหว่างการศึกษาของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table19profileresidence_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table19profileresidence_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table19profileresidence_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.19 ลักษณะที่อยู่อาศัยในระหว่างการศึกษาของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a href="./table19profileresidence_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ลักษณะที่อยู่อาศัยในระหว่างการศึกษา</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>บ้าน</td><td bgcolor=#97d079>หอพักมหาวิทยาลัย</td><td bgcolor=#97d079>หอพักเอกชน / ห้องเช่า</td><td bgcolor=#97d07>คอนโดมิเนียม</td><td bgcolor=#97d079>วัด</td><td bgcolor=#97d079>บ้านเช่า</td><td bgcolor=#97d079>แฟลต / บ้านพักสวัสดิการ</td><td bgcolor=#97d079>ตึกแถว / เทาวน์เฮ้าส์</td></tr></table>	</td></tr></table>',
			
        title: ' 3.19 ลักษณะที่อยู่อาศัยในระหว่างการศึกษาของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_19_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ลักษณะที่อยู่อาศัยในระหว่างการศึกษา</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>บ้าน</td><td bgcolor=#97d079>หอพักมหาวิทยาลัย</td><td bgcolor=#97d079>หอพักเอกชน / ห้องเช่า</td><td bgcolor=#97d07>คอนโดมิเนียม</td><td bgcolor=#97d079>วัด</td><td bgcolor=#97d079>บ้านเช่า</td><td bgcolor=#97d079>แฟลต / บ้านพักสวัสดิการ</td><td bgcolor=#97d079>ตึกแถว / เทาวน์เฮ้าส์</td></tr></table>	</td></tr></table>',
        width: 1698,
        height: 600,
