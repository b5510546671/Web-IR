...
<html>
    <head>
        ...
        <title>
             3.11 สถานภาพสมรสของบิดามารดาของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table11parentstatus_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table11parentstatus_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table11parentstatus_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.11 สถานภาพสมรสของบิดามารดาของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a href="./table11parentstatus_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>สถานภาพสมรสของบิดามารดา</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>อยู่ด้วยกัน</td><td bgcolor=#97d079>แยกกันอยู่</td><td bgcolor=#97d079>หย่าร้าง</td><td bgcolor=#97d07>บิดา/มารดาถึงแก่กรรม</td><td bgcolor=#97d079>บิดาและมารดาถึงแก่กรรม</td><td bgcolor=#97d079>บิดา/มารดาแต่งงานใหม่</td><td bgcolor=#97d079>บิดาและมารดาแต่งงานใหม่</td></tr></table>	</td></tr></table>',
			
        title: ' 3.11 สถานภาพสมรสของบิดามารดาของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_11_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>สถานภาพสมรสของบิดามารดา</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>อยู่ด้วยกัน</td><td bgcolor=#97d079>แยกกันอยู่</td><td bgcolor=#97d079>หย่าร้าง</td><td bgcolor=#97d07>บิดา/มารดาถึงแก่กรรม</td><td bgcolor=#97d079>บิดาและมารดาถึงแก่กรรม</td><td bgcolor=#97d079>บิดา/มารดาแต่งงานใหม่</td><td bgcolor=#97d079>บิดาและมารดาแต่งงานใหม่</td></tr></table>	</td></tr></table>',
        width: 1550,
        height: 600,
