...
<html>
    <head>
        ...
        <title>
             3.23 ความต้องการเกี่ยวกับรูปแบบการรับน้องใหม่ของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table23generalwelcome_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table23generalwelcome_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table23generalwelcome_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.23 ความต้องการเกี่ยวกับรูปแบบการรับน้องใหม่ของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 500px;"><a href="./table23generalwelcome_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=5>ความต้องการเกี่ยวกับรูปแบบการรับน้องใหม่</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>รับแบบเพื่อนใหม่อย่างอบอุ่น</td><td bgcolor=#97d079>รับแบบตามประเพณีและ<br>รุ่นพี่เคยปฏิบัติมา</td><td bgcolor=#97d079>รับแบบมีกิจกรรม<br>สร้างสรรค์สังคม</td><td bgcolor=#97d07>รับแบบประชุมเชียร์และ<br>มีกิจกรรมรับน้อง</td><td bgcolor=#97d07>ไม่อยากให้มีการรับน้อง</td></tr></table>	</td></tr></table>',
			
        title: ' 3.23 ความต้องการเกี่ยวกับรูปแบบการรับน้องใหม่ของนิสิตใหม่ ปีการศึกษา 25 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 500px;"><a target="_blank" href="./3_23_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=5>ความต้องการเกี่ยวกับรูปแบบการรับน้องใหม่</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>รับแบบเพื่อนใหม่อย่างอบอุ่น</td><td bgcolor=#97d079>รับแบบตามประเพณีและ<br>รุ่นพี่เคยปฏิบัติมา</td><td bgcolor=#97d079>รับแบบมีกิจกรรม<br>สร้างสรรค์สังคม</td><td bgcolor=#97d07>รับแบบประชุมเชียร์และ<br>มีกิจกรรมรับน้อง</td><td bgcolor=#97d07>ไม่อยากให้มีการรับน้อง</td></tr></table>	</td></tr></table>',
        width: 1260,
        height: 600,
