...
<html>
    <head>
        ...
        <title>
             3.25 ปัญหาที่อยากให้คณะทราบและหาทางช่วยเหลือของนิสิตใหม่ ปีการศึกษา 25  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table25generalproblem1map25_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table25generalproblem1map25_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table25generalproblem1map25_data.php?yr='
			},
			root: {
				expanded: true
			},
