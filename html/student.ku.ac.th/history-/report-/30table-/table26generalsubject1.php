...
<html>
    <head>
        ...
        <title>
             3.26 วิชาที่คาดว่าจะมีปัญหามากที่สุดของนิสิตใหม่ ปีการศึกษา 25  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table26generalsubject1_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table26generalsubject1_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table26generalsubject1_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.26 วิชาที่คาดว่าจะมีปัญหามากที่สุดของนิสิตใหม่ ปีการศึกษา 2554  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a href="./table26generalsubject1_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>วิชาที่คาดว่าจะมีปัญหามากที่สุด</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>คณิตศาสตร์</td><td bgcolor=#97d079>ฟิสิกส์</td><td bgcolor=#97d079>เคมี</td><td bgcolor=#97d07>ชีววิทยา</td><td bgcolor=#97d079>ภาษาต่างประเทศ</td><td bgcolor=#97d079>ภาษาไทย</td><td bgcolor=#97d079>สังคมศึกษา</td></tr></table>	</td></tr></table>',
			
        title: ' 3.26 วิชาที่คาดว่าจะมีปัญหามากที่สุดของนิสิตใหม่ ปีการศึกษา 25  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_26_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>วิชาที่คาดว่าจะมีปัญหามากที่สุด</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>คณิตศาสตร์</td><td bgcolor=#97d079>ฟิสิกส์</td><td bgcolor=#97d079>เคมี</td><td bgcolor=#97d07>ชีววิทยา</td><td bgcolor=#97d079>ภาษาต่างประเทศ</td><td bgcolor=#97d079>ภาษาไทย</td><td bgcolor=#97d079>สังคมศึกษา</td></tr></table>	</td></tr></table>',
        width: 1552,
        height: 600,
