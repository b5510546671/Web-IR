...
<html>
    <head>
        ...
        <title>
             3.28 ความต้องการที่อยากให้คณะทราบและหาทางช่วยเหลือของนิสิตใหม่ ปีการศึกษา 25  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
	...
	if(yr=='54'){
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table28generalproblem1map28_data54.json'		
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table28generalproblem1map28_data55.json'	
			},
			root: {
				expanded: true
			},
		...
		var store = new ext.data.treestore({
			...
			proxy: {
				type: 'ajax',
				//the store will get the content from the .json file
				url: 'table28generalproblem1map28_data.php?yr='
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' 3.28 ความต้องการที่อยากให้คณะทราบและหาทางช่วยเหลือของนิสิตใหม่ ปีการศึกษา 2554  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left:735px;"><a href="./table28generalproblem1map28_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ความต้องการที่อยากให้คณะทราบและหาทางช่วยเหลือของนิสิตใหม่</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ความต้องการด้านการเงิน<br>และทุนการศึกษา</td><td bgcolor=#97d079>ความต้องการด้านหลักสูตร<br>และกิจกรรมเสริมหลักสูตร</td><td bgcolor=#97d079>ความต้องการด้านข้อมูล กิจกรรม<br>และการให้คำปรึกษา</td><td bgcolor=#97d07>ความต้องการให้บริการ<br>ของมหาวิทยาลัย</td><td bgcolor=#97d079>ความต้องการด้านการพัฒนา<br>สภาพแวดล้อมในมหาวิทยาลัย</td><td bgcolor=#97d079>ความต้องการด้านการสอน<br>และให้คำปรึกษาของอาจารย์</td><td bgcolor=#97d079>ความต้องการการให้<br>คำปรึกษาจากรุ่นพี่</td></tr></table>	</td></tr></table>',
			
        title: ' 3.28 ความต้องการที่อยากให้คณะทราบและหาทางช่วยเหลือของนิสิตใหม่ ปีการศึกษา 25  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left:735px;"><a target="_blank" href="./3_28_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ความต้องการที่อยากให้คณะทราบและหาทางช่วยเหลือของนิสิตใหม่</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ความต้องการด้านการเงิน<br>และทุนการศึกษา</td><td bgcolor=#97d079>ความต้องการด้านหลักสูตร<br>และกิจกรรมเสริมหลักสูตร</td><td bgcolor=#97d079>ความต้องการด้านข้อมูล กิจกรรม<br>และการให้คำปรึกษา</td><td bgcolor=#97d07>ความต้องการให้บริการ<br>ของมหาวิทยาลัย</td><td bgcolor=#97d079>ความต้องการด้านการพัฒนา<br>สภาพแวดล้อมในมหาวิทยาลัย</td><td bgcolor=#97d079>ความต้องการด้านการสอน<br>และให้คำปรึกษาของอาจารย์</td><td bgcolor=#97d079>ความต้องการการให้<br>คำปรึกษาจากรุ่นพี่</td></tr></table>	</td></tr></table>',
        width: 1552,
        height: 600,
