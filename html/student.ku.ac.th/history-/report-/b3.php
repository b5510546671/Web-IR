...
<html>
    <head>
        ...
        <title>
            1.3 รายงานสรุปจำนวนผู้ผ่านขั้นตอนการเป็นนิสิตใหม่(ไม่รวมสละสิทธิ์)
        </title>
...
ext.onready(function() {
    ...
    var tree = new ext.tree.treepanel({
        title: ' 1.3 รายงานสรุปจำนวนผู้ผ่านขั้นตอนการเป็นนิสิตใหม่(ไม่รวมสละสิทธิ์)<span style="margin-left: 745px;"><!-- <a href="./b3_export.php?yr="><img src="../image/csv.png" width="30" height="30" border="0" alt="export data..."></a> --></span>',
        width: 1180,
        height: 600,
