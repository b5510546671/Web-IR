...
<html>
    <head>
        ...
        <title>
             table12 สถานภาพสมรสของบิดามารดาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table12_data.php?yr='
				//url: 'table12_data59.json'	
			},
			root: {
				expanded: true
			},
