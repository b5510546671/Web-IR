...
<html>
    <head>
        ...
        <title>
             table15 อาชีพของบิดาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table15_data.php?yr='
				//url: 'table15_data59.json'	
			},
			root: {
				expanded: true
			},
