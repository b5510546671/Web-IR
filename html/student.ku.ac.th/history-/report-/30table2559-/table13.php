...
<html>
    <head>
        ...
        <title>
             table13 ระดับการศึกษาของบิดาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table13_data.php?yr='
				//url: 'table13_data59.json'	
			},
			root: {
				expanded: true
			},
