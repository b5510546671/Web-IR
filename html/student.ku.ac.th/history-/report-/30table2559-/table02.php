...
<html>
    <head>
        ...
        <title>
             table02 อายุของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				//url: 'table02_data.php?yr='	
				url: 'table02_data59_2.json'	
			},
			root: {
				expanded: true
			},
