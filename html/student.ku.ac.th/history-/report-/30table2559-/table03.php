...
<html>
    <head>
        ...
        <title>
             table03 ความปกติความพิการด้านต่างๆ ของนิสิตใหม่ จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table03_data.php?yr='	
				//url: 'table03_data59.json'	
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        title: ' table03 ความปกติความพิการด้านต่างๆ ของนิสิตใหม่ จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_2_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:380px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 rowspan=2>ปกติ</td><td bgcolor=#97d079 rowspan=2>ความพิการ</td><td bgcolor=#97d079 colspan=9>ความพิการ</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ความบกพร่อง<br>จากการมองเห็น</td><td bgcolor=#97d079>ความบกพร่อง<br>ทางการได้ยิน</td>	<td bgcolor=#97d079>ความบกพร่อง<br>ทางสติปัญญา</td><td bgcolor=#97d079>ความบกพร่อง<br>ทางร่างกาย</td><td bgcolor=#97d079>ความบกพร่อง<br>ทางการพูด</td><td bgcolor=#97d079>ปัญหาทาง<br>การเรียนรู้</td>	<td bgcolor=#97d079>ปัญหาทางพฤติกรรม<br>/อารมณ์ มีความเบี่ยงเบนไป<br>จากปกติ</td><td bgcolor=#97d079><br>บุคคลออทิสติก</td><td bgcolor=#97d079><br>บุคคลพิการซ้ำซ้อน</td></tr></table></td></tr></table>',
        width: 2245,
        height: 600,
