...
<html>
    <head>
        ...
        <title>
             table18 ค่าใช้จ่ายส่วนตัวที่ได้รับต่อเดือนของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table18_data.php?yr='
				//url: 'table18_data59.json'	
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' table18 ค่าใช้จ่ายส่วนตัวที่ได้รับต่อเดือนของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a href="./table17familysalary_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ค่าใช้จ่ายส่วนตัวที่ได้รับต่อเดือน</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ต่ำกว่า 2,500 บาท</td><td bgcolor=#97d079>2,501-3,500 บาท</td><td bgcolor=#97d079>3,501-4,500 บาท</td><td bgcolor=#97d07>4,501-5,500 บาท</td><td bgcolor=#97d079>5,501-7,500 บาท</td><td bgcolor=#97d079>7,501-9,500 บาท</td><td bgcolor=#97d079>มากกว่า 9,500 บาท</td></tr></table>	</td></tr></table>',
			
        //title: ' table18 ค่าใช้จ่ายส่วนตัวที่ได้รับต่อเดือนของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_17_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ค่าใช้จ่ายส่วนตัวที่ได้รับต่อเดือน</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ต่ำกว่า 2,500 บาท</td><td bgcolor=#97d079>2,501-3,500 บาท</td><td bgcolor=#97d079>3,501-4,500 บาท</td><td bgcolor=#97d07>4,501-5,500 บาท</td><td bgcolor=#97d079>5,501-7,500 บาท</td><td bgcolor=#97d079>7,501-9,500 บาท</td><td bgcolor=#97d079>มากกว่า 9,500 บาท</td></tr></table>	</td></tr></table>',
			
        title: ' table18 ค่าใช้จ่ายส่วนตัวที่ได้รับต่อเดือนของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_17_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>ค่าใช้จ่ายส่วนตัวที่ได้รับต่อเดือน</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ไม่เกิน 3,000 บาท</td><td bgcolor=#97d079>3,001-4,000 บาท</td><td bgcolor=#97d079>4,001-5,000 บาท</td><td bgcolor=#97d07>5,001-6,000 บาท</td><td bgcolor=#97d079>6,001-7,000 บาท</td><td bgcolor=#97d079>7,001-8,000 บาท</td><td bgcolor=#97d079>8,001-9,000 บาท</td><td bgcolor=#97d079>9,001-10,000 บาท</td><td bgcolor=#97d079>มากกว่า 10,000 บาท</td></tr></table>	</td></tr></table>',
        width: 1800,
        height: 600,
