...
<html>
    <head>
        ...
        <title>
             table07 เหตุผลที่เลือกศึกษาในมหาวิทยาลัยเกษตรศาสตร์  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table07_data.php?yr='
				//url: 'table07_data59.json'	
			},
			root: {
				expanded: true
			},
