...
<html>
    <head>
        ...
        <title>
             table06 ภูมิลำเนาและจังหวัดที่เกิดของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table06_data.php?yr='
				//url: 'table06_data59.json'	
			},
			root: {
				expanded: true
			},
