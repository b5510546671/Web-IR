...
<html>
    <head>
        ...
        <title>
             table01 เพศของนิสิตใหม่ จำแนกตามวิทยาเขต กลุ่มสาขา ประเภทโครงการ และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table01_data.php?yr='	
				//url: 'table01_data59.json'	
			},
			root: {
				expanded: true
			},
