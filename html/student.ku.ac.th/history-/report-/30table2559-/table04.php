...
<html>
    <head>
        ...
        <title>
             table04 การนับถือศาสนาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table04_data.php?yr='	
				//url: 'table04_data59.json'	
			},
			root: {
				expanded: true
			},
