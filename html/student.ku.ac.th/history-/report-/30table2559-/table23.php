...
<html>
    <head>
        ...
        <title>
             table23  ความประสงค์ในการขอรับเงินอุดหนุนการศึกษาของนิสิตใหม่ จำแนกตามวิทยาเขต กลุ่มสาขา ประเภทโครงการ และคณะ
        </title>
...
ext.onready(function() {
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table23_data.php?yr='
				//url: 'table23_data59.json'	
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        ...
        title: 'table23  ความประสงค์ในการขอรับเงินอุดหนุนการศึกษาของนิสิตใหม่ จำแนกตามวิทยาเขต กลุ่มสาขา ประเภทโครงการ และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_22_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=11>ความประสงค์ในการขอรับเงินอุดหนุนการศึกษาของนิสิตใหม่</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ไม่ประสงค์</td><td bgcolor=#97d079>ขอรับทุนการศึกษา</td><td bgcolor=#97d079>ขอกู้เงินจากกองทุนกู้ยืม</td></tr></table>	</td></tr></table>',
        width: 965,
        height: 600,
