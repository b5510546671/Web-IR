...
<html>
    <head>
        ...
        <title>
             table26 ความประสงค์ในการทำงานพิเศษหรือฝึกงานในระหว่างปิดภาคเรียนของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table26_data.php?yr='
				//url: 'table26_data59.json'
			},
			root: {
				expanded: true
			},
