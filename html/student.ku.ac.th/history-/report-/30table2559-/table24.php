...
<html>
    <head>
        ...
        <title>
             table24  การทำงานก่อนเข้าศึกษาในมหาวิทยาลัยเกษตรศาสตร์ของนิสิตใหม่ จำแนกตามวิทยาเขต กลุ่มสาขา ประเภทโครงการ และคณะ
        </title>
...
ext.onready(function() {
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table24_data.php?yr='
				//url: 'table24_data59.json'	
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        ...
        title: 'table24  การทำงานก่อนเข้าศึกษาในมหาวิทยาลัยเกษตรศาสตร์ของนิสิตใหม่ จำแนกตามวิทยาเขต กลุ่มสาขา ประเภทโครงการ และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_22_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=11>การทำงานก่อนเข้าศึกษาในมหาวิทยาลัยเกษตรศาสตร์ของนิสิตใหม่</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ทำงานและปัจจุบันยังทำอยู่</td><td bgcolor=#97d079>ทำงานแต่ปัจจุบันไม่ได้ทำงาน</td><td bgcolor=#97d079>ไม่ได้ทำงาน</td></tr></table>	</td></tr></table>',
        width: 965,
        height: 600,
