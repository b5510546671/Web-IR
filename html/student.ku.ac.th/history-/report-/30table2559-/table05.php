...
<html>
    <head>
        ...
        <title>
             table05 ภูมิลำเนาของนิสิตใหม่ ปีการศึกษา จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table05_data.php?yr='	
				//url: 'table05_data59.json'	
			},
			root: {
				expanded: true
			},
