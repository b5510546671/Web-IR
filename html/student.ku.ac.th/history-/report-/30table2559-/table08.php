...
<html>
    <head>
        ...
        <title>
             table08 เหตุผลที่เลือกสาขาวิชาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table08_data.php?yr='
				//url: 'table08_data59.json'	
			},
			root: {
				expanded: true
			},
