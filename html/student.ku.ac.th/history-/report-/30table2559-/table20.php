...
<html>
    <head>
        ...
        <title>
             table20 ลักษณะที่อยู่อาศัยในระหว่างการศึกษาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table20_data.php?yr='
				//url: 'table20_data59.json'	
			},
			root: {
				expanded: true
			},
