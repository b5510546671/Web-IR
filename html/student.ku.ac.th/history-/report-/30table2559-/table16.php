...
<html>
    <head>
        ...
        <title>
             table16 อาชีพของมารดาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
...
ext.onready(function() {
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table16_data.php?yr='
				//url: 'table16_data59.json'	
			},
			root: {
				expanded: true
			},
    ...
    var tree = new ext.tree.treepanel({
        //title: ' table16 อาชีพของมารดาของนิสิตใหม่ ปีการศึกษา 2554 จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a href="./table15motheroccup_export.php?yr=54"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>อาชีพของมารดา</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ข้าราชการ/<br>พนักงาน/<br>ลูกจ้างของรัฐ</td><td bgcolor=#97d079>พนักงาน/<br>ลูกจ้างรัฐวิสาหกิจ</td><td bgcolor=#97d079>พนักงาน/<br>ลูกจ้างหน่วยงานเอกชน</td><td bgcolor=#97d07>ค้าขาย</td><td bgcolor=#97d079>ธุรกิจส่วนตัว/<br>อาชีพอิสระ</td><td bgcolor=#97d079>รับจ้างทั่วไป</td><td bgcolor=#97d079>เกษตรกรรม/<br>ปศุสัตว์/<br>ประมง</td><td bgcolor=#97d079>ไม่ได้ประกอบอาชีพ  </td></tr></table>	</td></tr></table>',
			
        title: ' table16 อาชีพของมารดาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ<span style="margin-left: 935px;"><a target="_blank" href="./3_15_export25.csv"><img src="../../image/csv.png" width="30" height="30" border="0" alt="export data..."></a></span><br><table  style="border: 1 solid white; font-weight: lighter; color: black;"><tr><td style="width:360px;">&nbsp;</td><td><table class="mytable"><tr><td bgcolor=#97d079 colspan=9>อาชีพของบิดา</td><td bgcolor=#97d079 rowspan=2>รวม</td></tr><tr><td bgcolor=#97d079>ข้าราชการ/พนักงาน/<br>ลูกจ้างของรัฐ/พนักงาน/<br>รัฐวิสาหกิจ/<br>องค์การต่างประเทศ/<br>ระหว่างประเทศ</td><td bgcolor=#97d079>พนักงาน/<br>ลูกจ้างหน่วยงานเอกชน</td><td bgcolor=#97d07>ค้าขาย/ธุรกิจส่วนตัว</td><td bgcolor=#97d079>เจ้าของกิจการ</td><td bgcolor=#97d079>รับจ้างทั่วไป/<br>อาชีพอิสระ</td><td bgcolor=#97d079>เกษตรกรรม/<br>ปศุสัตว์/<br>ประมง</td><td bgcolor=#97d079>ไม่ได้ประกอบอาชีพ  </td></tr></table>	</td></tr></table>',
        width: 1698,
        height: 600,
