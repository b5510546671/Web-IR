...
<html>
    <head>
        ...
        <title>
             table19 ผู้อุปการะค่าเล่าเรียน และค่าใช้จ่ายส่วนตัวของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
       ...
       var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table19_data.php?yr='
				//url: 'table19_data59.json'	
			},
			root: {
				expanded: true
			},
