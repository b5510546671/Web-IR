...
<html>
    <head>
        ...
        <title>
             table10 คะแนนเฉลี่ยของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table10_data.php?yr='
				//url: 'table10_data59.json'	
			},
			root: {
				expanded: true
			},
