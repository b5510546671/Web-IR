...
<html>
    <head>
        ...
        <title>
             table25 ความต้องการเกี่ยวกับรูปแบบการรับน้องใหม่ของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table25_data.php?yr='
				//url: 'table25_data59.json'
			},
			root: {
				expanded: true
			},
