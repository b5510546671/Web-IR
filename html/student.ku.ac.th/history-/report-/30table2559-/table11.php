...
<html>
    <head>
        ...
        <title>
             table11 ภาคที่จบการศึกษาของนิสิตใหม่  จำแนกตามวิทยาเขต กลุ่มสาขา และคณะ
        </title>
    ...
    var yr=document.getelementbyid('yr').value;
		var store = new ext.data.treestore({
			...
			proxy: {
				...
				url: 'table11_data.php?yr='
				//url: 'table11_data59.json'	
			},
			root: {
				expanded: true
			},
